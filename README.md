...
## The sketches here...
 * TwitterMentionsWall - The main project, bringing it all together - seems to be an issue with getting Temboo to play nicely with NeoPixel_matrix. maybe interrupts? https://learn.adafruit.com/neopixels-and-servos/overview
